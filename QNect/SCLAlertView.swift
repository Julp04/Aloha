...
let kCircleHeightBackgrounds: CGFloat = 62.0
...
open class SCLAlertView: UIViewController {
    ...
    let kCircleIconHeight: CGFloat = 50.0
    ...
    var circleBG = UIView(frame:CGRect(x:0, y:0, width:kCircleHeightBackgrounds, height:kCircleHeightBackgrounds))
    ...
    required public init() {
        ...
        let x = (kCircleHeightBackgrounds - kCircleHeight) / 2
    ...
    override open func viewWillLayoutSubviews() {
        ...
        contentView.layer.cornerRadius = contentViewCornerRadius
        y -= kCircleHeightBackgrounds * 0.6
        x = (sz.width - kCircleHeightBackgrounds) / 2
        circleBG.frame = CGRect(x:x, y:y+6, width:kCircleHeightBackgrounds, height:kCircleHeightBackgrounds)
    ...
    open func showError(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0xC1272D, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, image: nil, duration: duration, completeText:closeButtonTitle, style: .error, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
    ...
    open func showNotice(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x727375, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, image: nil, duration: duration, completeText:closeButtonTitle, style: .notice, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
    ...
    open func showWait(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt?=0xD62DA5, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, image: nil, duration: duration, completeText:closeButtonTitle, style: .wait, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
    ...
    open func showEdit(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0xA429FF, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, image: nil, duration: duration, completeText:closeButtonTitle, style: .edit, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
    ...
    open func showTitle(_ title: String, subTitle: String, image:UIImage?,duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?, colorTextButton: UInt?) -> SCLAlertViewResponder {
        selfReference = self
        view.alpha = 0
        let rv = UIApplication.shared.keyWindow! as UIWindow
        rv.addSubview(view)
