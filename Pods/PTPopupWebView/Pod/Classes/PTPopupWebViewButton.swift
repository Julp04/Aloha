...
open class PTPopupWebViewButton {
    ...
    /// Button's title
   @discardableResult open func title (_ title:String) -> Self {
        self.title = title
        return self
    }

    /// Button's background color
   @discardableResult open func backgroundColor (_ color:UIColor?) -> Self {
   ...
   @discardableResult open func handler (_ handler:(() -> ())?) -> Self {
