//
//  QNectAlertView.swift
//  QNectAlertView Example
//
//
...
// Pop Up Styles
public enum QNectAlertViewStyle {
    case success, error, notice, warning, info, edit, wait, contact
}
...
// Example: QNectAlertView().showSuccess(self, title: "Test", subTitle: "Value").close()
open class QNectAlertViewResponder {
    let alertview: QNectAlertView
    
    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: QNectAlertView) {
...
let kCircleHeightBackground: CGFloat = 125.0

public typealias DismissBlock = () -> Void

// The Main Class
open class QNectAlertView: UIViewController {
    ...
    var circleBG = UIImageView(frame:CGRect(x:0, y:0, width:kCircleHeightBackground, height:kCircleHeightBackground))
    var circleView = UIImageView(frame:CGRect(x:0, y:0, width:kCircleHeightBackground, height:kCircleHeightBackground))
    var circleIconView : UIView?
    var durationTimer: Timer!
    var dismissBlock : DismissBlock?
    fileprivate var inputs = [UITextField]()
    fileprivate var buttons = [SCLButton]()
    fileprivate var selfReference: QNectAlertView?
    ...
    required public init() {
        ...
        let tapToDismissGesture = UITapGestureRecognizer(target: self, action: #selector(QNectAlertView.hideView))
        tapToDismissGesture.numberOfTapsRequired = 1
        baseView.addGestureRecognizer(tapToDismissGesture)
    ...
    override open func viewWillLayoutSubviews() {
        ...
        circleBG.frame = CGRect(x:x, y:y - 5, width:kCircleHeightBackground, height:kCircleHeightBackground)
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(QNectAlertView.keyboardWillShow(_:)), name:NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(QNectAlertView.keyboardWillHide(_:)), name:NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
   ...
   @discardableResult open func addButton(_ title:String, action:@escaping ()->Void)->SCLButton {
        ...
        btn.action = action
        btn.addTarget(self, action:#selector(QNectAlertView.buttonTapped(_:)), for:.touchUpInside)
        btn.addTarget(self, action:#selector(QNectAlertView.buttonTapDown(_:)), for:[.touchDown, .touchDragEnter])
        btn.addTarget(self, action:#selector(QNectAlertView.buttonRelease(_:)), for:[.touchUpInside, .touchUpOutside, .touchCancel, .touchDragOutside] )
        return btn
    }
   ...
   @discardableResult open func addButton(_ title:String, target:AnyObject, selector:Selector)->SCLButton {
    ...
    open func showSuccess(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x22B573, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .success, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    // showError(view, title, subTitle)
    open func showError(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0xC1272D, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .error, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    // showNotice(view, title, subTitle)
    open func showNotice(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x727375, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .notice, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    // showWarning(view, title, subTitle)
    open func showWarning(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0xFFD110, colorTextButton: UInt=0x000000) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .warning, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    // showInfo(view, title, subTitle)
    open func showInfo(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0x2866BF, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .info, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    // showWait(view, title, subTitle)
    open func showWait(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt?=0xD62DA5, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .wait, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
    
    open func showEdit(_ title: String, subTitle: String, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=0xA429FF, colorTextButton: UInt=0xFFFFFF) -> QNectAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .edit, colorStyle: colorStyle, colorTextButton: colorTextButton, contactImage: nil)
    }
   ...
   @discardableResult open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: QNectAlertViewStyle, colorStyle: UInt?, colorTextButton: UInt?, contactImage:UIImage?) -> QNectAlertViewResponder {
        ...
        case .success:
            ...
            iconImage = QNectAlertViewStyleKit.imageOfCheckmark
            
        case .error:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = QNectAlertViewStyleKit.imageOfCross
            
        case .notice:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = QNectAlertViewStyleKit.imageOfNotice
            
        case .warning:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = QNectAlertViewStyleKit.imageOfWarning
            
        case .info:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = QNectAlertViewStyleKit.imageOfInfo
            
        case .edit:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = QNectAlertViewStyleKit.imageOfEdit
        ...
        case .contact:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = UIImage(named: "pinterest_circle")
        }
        ...
        if showCloseButton {
            ...
            addButton(txt, target:self, selector:#selector(QNectAlertView.hideView))
        }
...
//        circleView.backgroundColor = viewColor
        ...
        if style == .wait {
            ...
            if contactImage != nil {
                circleBG.image = contactImage
            }else {
                circleBG.image = iconImage
            }
        }
        ...
        if duration > 0 {
            ...
            durationTimer = Timer.scheduledTimer(timeInterval: duration!, target: self, selector: #selector(QNectAlertView.hideView), userInfo: nil, repeats: false)
        }
        ...
        // Chainable objects
        return QNectAlertViewResponder(alertview: self)
    }
    
    // Close QNectAlertView
...
class QNectAlertViewStyleKit : NSObject {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        QNectAlertViewStyleKit.drawCheckmark()
    ...
    class var imageOfCross: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        QNectAlertViewStyleKit.drawCross()
    ...
    class var imageOfNotice: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        QNectAlertViewStyleKit.drawNotice()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        QNectAlertViewStyleKit.drawWarning()
    ...
    class var imageOfInfo: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        QNectAlertViewStyleKit.drawInfo()
    ...
    class var imageOfEdit: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        QNectAlertViewStyleKit.drawEdit()
