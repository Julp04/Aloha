...
class OnboardViewController: UIViewController {
    ...
    let subtitleArray = ["Connecting with friends has never been so easy. Use your qr codes to quickly exchange info with friends", "Add contact info and other details to easily create your personal qr code", "Retreive users' info by quickly scanning their qr code. No internet connection required!", "Link different accounts like Twitter to easily follow other users without leaving the app"]
