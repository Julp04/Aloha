...
//        user.about = "I am cool"
    ...
    func createAccountsButtonsForLoggedInUser() {
        ...
        if let twitterScreenName = user.twitterAccount?.screenName {
            ...
            twitterButton = SwitchButton(frame: buttonFrame, onTintColor: .green, image: #imageLiteral(resourceName: "twitter_on"), shortText: "Add")
            twitterButton?.backgroundColor = UIColor.twitter.withAlphaComponent(0.5)
            twitterButton?.onClick = {
                self.twitterButton?.switchState()
    ...
    func createAccountsButtonsForOtherUser() {
        if let twitterScreenName = user.twitterAccount?.screenName {
            //User linked with twitter
            twitterButton = SwitchButton(frame: buttonFrame, onTintColor: .green, image: #imageLiteral(resourceName: "twitter_on"), shortText: "Follow")
            twitterButton?.backgroundColor = UIColor.twitter.withAlphaComponent(0.5)
            twitterButton?.onClick = {
                self.twitterButton?.switchState()
            }
